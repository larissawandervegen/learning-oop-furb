 ...
 * @author sunse
 */
public class AppQuestao02GUI extends javax.swing.JFrame {

    /**
     * Creates new form AppQuestao02GUI
     */
    public AppQuestao02GUI() {
        initComponents();
    }
...
//<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppQuestao02GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AppQuestao02GUI().setVisible(true);
            }
        });
    }
